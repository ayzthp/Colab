...
function Home() {
    _s();
    const { user, loading, signInWithGoogle, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$auth$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleJoinRoom = async (e)=>{
        e.preventDefault();
        if (roomId.trim()) {
            const roomRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], `rooms/${roomId.trim()}`);
...
_s(Home, "nK+BbX5mSeWkv+T6QZrw9lK34bc=", false, function() {
    return [
...
//# sourceMappingURL=_031a3e4e._.js.map